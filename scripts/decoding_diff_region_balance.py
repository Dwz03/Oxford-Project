...
df_cv.to_excel("data/cv_accuracy_balance_all.xlsx", index=False)

print("Saved: data/cv_accuracy_balance_all.xlsx")

df_acc = pd.read_excel("data/cv_accuracy_balance_all.xlsx")
